        ...
        [h('tr', [this._l(this.columns, function (column, cellIndex) {
          return h(
            ...
            [h(
              ...
              [column.renderFooter ? column.renderFooter.call(_this._renderProxy, h, { column: column, $index: cellIndex, value: sums[cellIndex], _self: _this.$parent.$vnode.context }) : sums[cellIndex]]
            )]
          );
